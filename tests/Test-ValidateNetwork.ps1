<#
.SYNOPSIS
    Prueba Validate-Network.ps1 contra los fixtures de red simulada.
.DESCRIPTION
    Ejecuta scripts/validation/Validate-Network.ps1 con -SystemInfoPath apuntando
    a cada JSON de tests/fixtures/network/, compara el Status esperado (campo
...
Write-Host ""
Write-Host "Test-ValidateNetwork" -ForegroundColor Cyan
